  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="container mx-auto px-4 py-16 relative">
        ...
        {/* Projects section */}
        <h2 className="text-4xl font-bold text-center mt-24 mb-12 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 animate-text reveal leading-loose">
          Featured Projects
        </h2>
